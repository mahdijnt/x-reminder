...
export function AuthLayoutShell({
  ...
  return (
    <div className={cn("relative isolate min-h-screen min-h-[100dvh] overflow-x-hidden", className)}>
      ...
      <div className="relative z-page-content mx-auto flex min-h-screen min-h-[100dvh] w-full max-w-md flex-col justify-center safe-area-shell py-10">
